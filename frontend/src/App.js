            ...
            <ThemeContext.Provider value={{ isDarkMode, toggleTheme }}>
                <RoutesWrapper isDarkMode={isDarkMode}>
                    <Routes>
                        ...
                        <Route element={<ProtectedRoute isAllowed={AuthService.getCurrentUser() && Array.isArray(AuthService.getCurrentUser().roles) && AuthService.getCurrentUser().roles.includes("ROLE_USER")} />}>
                        ...
                        <Route element={<ProtectedRoute isAllowed={AuthService.getCurrentUser() && Array.isArray(AuthService.getCurrentUser().roles) && AuthService.getCurrentUser().roles.includes("ROLE_ADMIN")} />}>
